--[[
	...
	Beluga X Universal by Arhan © CC0 1.0 Universal (2024)
	https://github.com/ArhanDevelops
...
local GUI = loadstring(game:HttpGet("https://raw.githubusercontent.com/ArhanDevelops/belugax/main/src/univlib.lua"))()
